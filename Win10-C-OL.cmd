...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /V "EnableFullTrustStartupTasks" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /V "EnableUwpStartupTasks" /T REG_DWORD /D "0" /F >NUL 2>&1
...
:: Orientation
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\AutoRotation" /V "Enable" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\AutoRotation" /V "LastOrientation" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\AutoRotation" /V "SlateEnable" /T REG_DWORD /D "1" /F >NUL 2>&1
:: Multiple Displays
REG ADD "HKEY_CURRENT_USER\Control Panel\Desktop" /V "RestorePreviousStateRecalcBehavior" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\Control Panel\Desktop" /V "MonitorRemovalRecalcBehavior" /T REG_DWORD /D "0" /F >NUL 2>&1
:: Projection
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Connect" /V "AllowProjectionToPC" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Connect" /V "RequirePinForPairing" /T REG_DWORD /D "2" /F >NUL 2>&1
:::: Sound
:: Mono Audio
REG ADD "HKEY_CURRENT_USER\Software\Microsoft\Multimedia\Audio" /V "AccessibilityMonoMixState" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: Notifications
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications" /V "NoCloudApplicationNotification" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications" /V "NoTileApplicationNotification" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications" /V "NoToastApplicationNotification" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications" /V "NoToastApplicationNotificationOnLockScreen" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications" /V "DisallowNotificationMirroring" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\ActionCenter\Quick Actions\All" /V "SystemSettings_Launcher_QuickNote" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\QuietHours" /V "AllowCalls" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: Power Battery Sleep
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\EnhancedStorageDevices" /V "DisallowLegacyDiskDevices" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\EnhancedStorageDevices" /V "LockDeviceOnMachineLock" /T REG_DWORD /D "1" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\EnhancedStorageDevices" /V "RootHubConnectedEnStorDevices" /T REG_DWORD /D "1" /F >NUL 2>&1
...
DISM.EXE /Online /Set-ReservedStorageState /State:Disabled /NoRestart >NUL 2>&1
:::: Troubleshoot
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Clipboard" /V "EnableClipboardHistory" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\System" /V "CloudClipboardAutomaticUpload" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\System" /V "EnableCloudClipboard" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System" /V "CloudClipboardAutomaticUpload" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System" /V "EnableCloudClipboard" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: Remote Desktop
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Component Based Servicing" /V "DisableWerReporting" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\SideBySide\Configuration" /V "CBSLogCompress" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\SideBySide\Configuration" /V "CreateNewWindowsVersion" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\SideBySide\Configuration" /V "DontRunPoqexecInSmss" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /V "PagingFiles" /T REG_MULTI_SZ /D "" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management\PrefetchParameters" /V "SfTracingState" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: Fast Startup
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications" /V "Disabled" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications" /V "DisabledByUser" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /V "SilentAppsEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\ImmersiveShell\StateStore" /V "ResetCacheCount" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /V "NoRecentDocsHistory" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V "DesktopProcess" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced\Folder\HideFileExt" /V "CheckedValue" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /V "DisableThumbnailCache" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /V "FolderContentsInfoTip" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /V "ListviewWatermark" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /V "SeparateProcess" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V "DesktopProcess" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V "DisableEdgeDesktopShortcutCreation" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V "DisplayToastAtBottom" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V "Max Cached Icons" /T REG_SZ /D "2048" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /V "EnforceShellExtensionSecurity" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Explorer" /V "CheckSameSourceAndTargetForFRAndDFS" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Explorer" /V "ClearTilesOnExit" /T REG_DWORD /D "1" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /V "NoDesktop" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\VolumeCaches\Thumbnail Cache" /V "Autorun" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Explorer\VolumeCaches\Thumbnail Cache" /V "Autorun" /T REG_DWORD /D "0" /F >NUL 2>&1
:: Explorer Ribbon
...
REG ADD "HKEY_USERS\.Default\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\NamingTemplates" /V "ShortcutNameTemplate" /T REG_SZ /D "%s.lnk" /F >NUL 2>&1
::IF EXIST IconOverlay.ico COPY /B /D /V /Y IconOverlay.ico /B /D /V /Y %LOCALAPPDATA%\IconOverlay.ico >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Shell Icons" /V "29" /T REG_EXPAND_SZ /D "%LOCALAPPDATA%\IconOverlay.ico" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\Control Panel\Desktop" /V "MouseHoverTime" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_USERS\.Default\Control Panel\Desktop" /V "MenuShowDelay" /T REG_SZ /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System" /V "AllowBlockingAppsAtShutdown" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "AutoApproveOSDumps" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassDataThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassNetworkCostThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassPowerThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "Disabled" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "DontSendAdditionalData" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "DontShowUI" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "LoggingDisabled" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting\Consent" /V "DefaultConsent" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\Windows Error Reporting\Consent" /V "DefaultOverrideBehavior" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "AutoApproveOSDumps" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassDataThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassNetworkCostThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "BypassPowerThrottling" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "Disabled" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "DontSendAdditionalData" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "DontShowUI" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /V "LoggingDisabled" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "AllOrNone" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "DoReport" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "ForceQueueMode" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "IncludeKernelFaults" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "IncludeMicrosoftApps" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "IncludeShutdownErrs" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "IncludeWindowsApps" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting" /V "ShowUI" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting\DW" /V "DWNoExternalURL" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting\DW" /V "DWNoFileCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\ErrorReporting\DW" /V "DWNoSecondLevelCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\HelpSvc" /V "Headlines" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PCHealth\HelpSvc" /V "MicrosoftKBSearch" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\AeDebug" /V "Auto" /T REG_SZ /D "0" /F >NUL 2>&1
...
:: Windows Script Host
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows Script Host\Settings" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Script Host\Settings" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows Script Host\Settings" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows Script\Settings" /V "JITDebug" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_USERS\.Default\SOFTWARE\Microsoft\Windows Script\Settings" /V "JITDebug" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CLASSES_ROOT\Directory\Shell\RunAs" /V "Extended" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Directory\Shell\RunAs" /V "HasLUAShield" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Directory\Shell\RunAs" /V "NoWorkingDirectory" /T REG_SZ /D "" /F >NUL 2>&1
...
REG ADD "HKEY_CLASSES_ROOT\Directory\Background\Shell\RunAs" /V "Extended" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Directory\Background\Shell\RunAs" /V "HasLUAShield" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Directory\Background\Shell\RunAs" /V "NoWorkingDirectory" /T REG_SZ /D "" /F >NUL 2>&1
...
REG ADD "HKEY_CLASSES_ROOT\Drive\Shell\RunAs" /V "Extended" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Drive\Shell\RunAs" /V "HasLUAShield" /T REG_SZ /D "" /F >NUL 2>&1
REG ADD "HKEY_CLASSES_ROOT\Drive\Shell\RunAs" /V "NoWorkingDirectory" /T REG_SZ /D "" /F >NUL 2>&1
...
:: System Restore Creation Frequency
...
:: New Boot Animation
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\BootControl" /V "BootProgressAnimation" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\Control Panel\Mouse" /V "MouseHoverTime" /T REG_SZ /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\InputPersonalization" /V "AcceptedPrivacyPolicy" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\InputPersonalization" /V "HarvestContacts" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Personalization\Settings" /V "HarvestContacts" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\HandwritingErrorReports" /V "PreventHandwritingErrorReports" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Windows\TabletPC" /V "PreventHandwritingDataSharing" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\InputPersonalization" /V "AcceptedPrivacyPolicy" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\InputPersonalization" /V "HarvestContacts" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\InputPersonalization" /V "RestrictImplicitInkCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\InputPersonalization" /V "RestrictImplicitTextCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\InputPersonalization\TrainedDataStore" /V "HarvestContacts" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Input\TIPC" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Personalization\Settings" /V "AcceptedPrivacyPolicy" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Personalization\Settings" /V "HarvestContacts" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Personalization\Settings" /V "RestrictImplicitInkCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Personalization\Settings" /V "RestrictImplicitTextCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsInkWorkspace" /V "AllowSuggestedAppsInWindowsInkWorkspace" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: AutoPlay
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\LooselyCoupled" /V "value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" /V "SensorPermissionState" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\DeviceAccess\Global\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" /V "Status" /T REG_SZ /D "Off" /F >NUL 2>&1
:: StorPort
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\StorPort" /V "TelemetryErrorDataEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\StorPort" /V "TelemetryPerformanceEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\StorPort" /V "Tele-metry-DeviceHealthEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
:: Wacon
REG DELETE "HKEY_CURRENT_USER\SOFTWARE\Wacom\Analytics\Analytics_On" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Associations" /V "DefaultFileTypeRisk" /T REG_DWORD /D "1808" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\FindMyDevice" /V "AllowFindMyDevice" /T REG_DWORD /D "0" /F >NUL 2>&1
...
:: NetBIOS over TCP/IP
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NetBT\Parameters" /V "EnableLMHOSTS" /T REG_DWORD /D "0" /F >NUL 2>&1
...
:: TCP/IP
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\NUMA" /V "SplitLargeNodes" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AFD\Parameters" /V "NonBlockingSendSpecialBuffering" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "DeadGWDetect" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "DeadGWDetectDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "EnableFragmentChecking" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "EnablePMTUBHDetect" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "EnableRSS" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "EnableTCPA" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP\Parameters" /V "SackOpts" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "DeadGWDetect" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "DeadGWDetectDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "DisableTaskOffload" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnableDCA" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnableDeadGWDetect" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnableFragmentChecking" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnablePMTUBHDetect" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnablePMTUDiscovery" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnableRSS" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "EnableTCPA" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters" /V "SackOpts" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WcmSvc\WiFiNetworkManager\Features\SocialNetworks\ABCH" /V "OptInStatus" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WcmSvc\WiFiNetworkManager\Features\SocialNetworks\ABCH-SKYPE" /V "OptInStatus" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WcmSvc\WiFiNetworkManager\Features\SocialNetworks\FACEBOOK" /V "OptInStatus" /T REG_DWORD /D "0" /F >NUL 2>&1
...
:: SCHANNEL
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" /V "EnableOCSPStaplingForSNI" /T REG_DWORD /D "1" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" /V "AllowInsecureRenegoClients" /T REG_DWORD /D "1" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" /V "AllowInsecureRenegoServers" /T REG_DWORD /D "1" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" /V "DisableRenegoOnServer" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL" /V "UseScsvForTLS" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\AES 128/128" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\AES 256/256" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\NULL" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Hashes\SHA256" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Hashes\SHA384" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Hashes\SHA512" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\Diffie-Hellman" /V "Enabled" /T REG_DWORD /D "ffffffff" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\Diffie-Hellman" /V "ClientMinKeyBitLength" /T REG_DWORD /D "00001000" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\Diffie-Hellman" /V "ServerMinKeyBitLength" /T REG_DWORD /D "00001000" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\KeyExchangeAlgorithms\ECDH" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.0\Client" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.0\Client" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.0\Server" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.0\Server" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.1\Client" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.1\Client" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.1\Server" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\DTLS 1.1\Server" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\Multi-Protocol Unified Hello\Client" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\Multi-Protocol Unified Hello\Client" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\Multi-Protocol Unified Hello\Server" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
::REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\Multi-Protocol Unified Hello\Server" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\PCT 1.0\Client" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\PCT 1.0\Client" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\PCT 1.0\Server" /V "DisabledByDefault" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\PCT 1.0\Server" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
:::: Internet Settings
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones" /V "SelfHealCount" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\0" /V "CurrentLevel" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1" /V "CurrentLevel" /T REG_DWORD /D "12000" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\2" /V "CurrentLevel" /T REG_DWORD /D "12000" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3" /V "CurrentLevel" /T REG_DWORD /D "12000" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4" /V "CurrentLevel" /T REG_DWORD /D "12000" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "CallLegacyWCMPolicies" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "DisableCachingOfSSLPages" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "DisablePasswordCaching" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableHTTP2" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableNegotiate" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableSSL3Fallback" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "GlobalUserOffline" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "MaxConnectionsPer1_0Server" /T REG_DWORD /D "32" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "MaxConnectionsPerServer" /T REG_DWORD /D "32" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "PreventIgnoreCertErrors" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "PrivacyAdvanced" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "SecureProtocols" /T REG_DWORD /D "2048" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnonBadCertRecving" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnonZoneCrossing" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnOnIntranet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnOnPostRedirect" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "CertificateRevocation" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "LegacyTLSAppcompat" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "CallLegacyWCMPolicies" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "DisableCachingOfSSLPages" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "DisablePasswordCaching" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableHTTP2" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableNegotiate" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "EnableSSL3Fallback" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "GlobalUserOffline" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "PreventIgnoreCertErrors" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "PrivacyAdvanced" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "SecureProtocols" /T REG_DWORD /D "2048" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnonBadCertRecving" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnonZoneCrossing" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnOnIntranet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "WarnOnPostRedirect" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "CertificateRevocation" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings" /V "LegacyTLSAppcompat" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\WinHttp" /V "DefaultSecureProtocols" /T REG_DWORD /D "2048" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Internet Settings\WinHttp" /V "DefaultSecureProtocols" /T REG_DWORD /D "2048" /F >NUL 2>&1
:: EccCurves
...
:: MDM Enrollment
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\MDM" /V "DisableRegistration" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_USERS\.DEFAULT\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize" /V "ColorPrevalence" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "AlwaysHibernateThumbnails" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "Animations" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "ColorPrevalence" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "ColorizationBlurBalance" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "Composition" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "EnableWindowColorization" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\DWM" /V "UseMachineCheck" /T REG_DWORD /D "0" /F >NUL 2>&1
:::: Lock Screen
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows NT\MitigationOptions" /V "MitigationOptions_FontBocking" /T REG_DWORD /D "1000000000000" /F >NUL 2>&1
...
::REG ADD "HKEY_CURRENT_USER\SOFTWARE\Classes\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}\System.IsPinnedToNameSpaceTree" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\OneDrive" /V "DisablePersonalSync" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\OneDrive" /V "PreventNetworkTrafficPreUserSignIn" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\OneDrive" /V "DisablePersonalSync" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AcceptedPrivacyStatement" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AddToMRU" /T REG_DWORD /D "00" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AutoCopyCD" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AutoCopyCDWin7" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "CDRecordDRM" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "CDRecordMP3" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "DisableMRU" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "FirstRun" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "SendUserGUID" /T REG_BINARY /D "00" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "UsageTracking" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "GroupPrivacyAcceptance" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventCDDVDMetadataRetrieval" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventCodecDownload" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventLibrarySharing" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventMusicFileMetadataRetrieval" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventRadioPresetsRetrieval" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AddToMRU" /T REG_DWORD /D "00" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AutoCopyCD" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "AutoCopyCDWin7" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "CDRecordDRM" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MediaPlayer\Preferences" /V "CDRecordMP3" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventCodecDownload" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsMediaPlayer" /V "PreventLibrarySharing" /T REG_DWORD /D "1" /F >NUL 2>&1
...
:: AppUriHandlers
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\System" /V "EnableAppUriHandlers" /T REG_DWORD /D "0" /F >NUL 2>&1
:: Digital Locker
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Digital Locker" /V "DoNotRunDigitalLocker" /T REG_DWORD /D "1" /F >NUL 2>&1
...
:: Microsoft Accounts to be Optional
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\SettingSync\Groups\DesktopTheme" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\SettingSync\Groups\PackageState" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\SettingSync\Groups\StartLayout" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableSettingSyncUserOverride" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableAppSyncSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableApplicationSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableCredentialsSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableDesktopThemeSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisablePersonalizationSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableStartLayoutSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableWebBrowserSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync" /V "DisableWindowsSettingSync" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Messaging" /V "CloudServiceSyncEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Speech_OneCore\Settings\VoiceActivation\UserPreferenceForAllApps" /V "AgentActivationOnLockScreenEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech" /V "AllowSpeechModelUpdate" /T REG_DWORD /D "0" /F >NUL 2>&1
...
ECHO :::::::: Gaming
:: TruePlay / Game Bar / Game Mode
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Games" /V "EnableXBGM" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR" /V "AllowGameDVR" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG DELETE "HKEY_USERS\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\AdvertisingInfo" /F >NUL 2>&1
REG ADD "HKEY_USERS\.DEFAULT\Software\Microsoft\Windows\CurrentVersion\AdvertisingInfo" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG DELETE "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\AdvertisingInfo" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\AdvertisingInfo" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\ScriptedDiagnosticsProvider\Policy" /V "EnableQueryRemoteServer" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\EventLog\Security" /V "MaxSize" /T REG_DWORD /D "32768" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Siuf\Rules" /V "NumberOfSIUFInPeriod" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Siuf\Rules" /V "PeriodInNanoSeconds" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "DisableOneSettingsDownloads" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "DisableTelemetryOptInSettingsUx" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "EnableOneSettingsAuditing" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "LimitDiagnosticLogCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "LimitDumpCollection" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG DELETE "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /V "CommercialId" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Activity" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\AppDiagnostics" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Appointments" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Bluetooth" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\BluetoothSync" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\BluetoothSync" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\CellularData" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Chat" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Contacts" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\DocumentsLibrary" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\downloadsFolder" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\downloadsFolder" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Email" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\GazeInput" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\GazeInput" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\graphicsCaptureProgrammatic" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\graphicsCaptureProgrammatic" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\graphicsCaptureWithoutBorder" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\graphicsCaptureWithoutBorder" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Location" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Microphone" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Microphone" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\musicLibrary" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\musicLibrary" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\PhoneCall" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\PhoneCallHistory" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\PicturesLibrary" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Radios" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\UserAccountInformation" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\UserDataTasks" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\UserNotificationListener" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\UserNotificationListener" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\VideosLibrary" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\Webcam" /V "Value" /T REG_SZ /D "Deny" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\WiFiData" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\WiFiDirect" /V "Value" /T REG_SZ /D "Allow" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Search" /V "CortanaIsReplaceable" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Search" /V "CortanaIsReplaced" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Windows Search" /V "AllowCloudSearch" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PolicyManager\default\Experience\AllowCortana" /V "Value" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WindowsUpdate" /V "SupportsUUP" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WindowsUpdate\UX" /V "IsConvergedUpdateStackEnabled" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WindowsUpdate\UX\Settings" /V "RestartNotificationsAllowed2" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" /V "AUOptions" /T REG_DWORD /D "5" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" /V "NoAutoRebootWithLoggedOnUsers" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" /V "NoAutoUpdate" /T REG_DWORD /D "0" /F >NUL 2>&1
...
::REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\WindowsStore" /V "DisableStoreApps" /T REG_DWORD /D "1" /F >NUL 2>&1
:: Drivers Update
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" /V "DontSearchWindowsUpdate" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" /V "DriverUpdateWizardWuSearchEnabled" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" /V "SearchOrderConfig" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization" /V "SystemSettingsDownloadMode" /T REG_DWORD /D "3" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MRT" /V "DontOfferThroughWUAU" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\MRT" /V "DontReportInfectionInformation" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\MpEngine" /V "MpEnablePus" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Reporting" /V "DisableGenericReports" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\Scan" /V "CheckForSignaturesBeforeRunningScan" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\SpyNet" /V "DisableBlockAtFirstSeen" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\SpyNet" /V "LocalSettingOverrideSpyNetReporting" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\SpyNet" /V "SpyNetReporting" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\SpyNet" /V "SpyNetReportingLocation" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender\SpyNet" /V "SubmitSamplesConsent" /T REG_DWORD /D "2" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Defender" /V "PUAProtection" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PolicyManager\default\ADMX_MicrosoftDefenderAntivirus" /V "SpynetReporting" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PolicyManager\default\Defender" /V "SubmitSamplesConsent" /T REG_DWORD /D "0" /F >NUL 2>&1
:: Network Protection
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common" /V "QMEnable" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\Feedback" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\Feedback" /V "IncludeEmail" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\Feedback" /V "IncludeScreenshot" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\Feedback" /V "MSORIdSurveyEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\OSM" /V "EnableFileObfuscation" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\OSM" /V "EnableLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\OSM" /V "EnableUpload" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Outlook\Options\Calendar" /V "EnableCalendarLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Outlook\Options\Mail" /V "BlockExtContent" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Outlook\Options\Mail" /V "EnableLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Outlook\Options\Mail" /V "JunkMailEnableLinks" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Word\Options" /V "EnableLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Access\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Feedback" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Feedback" /V "IncludeEmail" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Feedback" /V "IncludeScreenshot" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Feedback" /V "MSORIdSurveyEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\General" /V "NoTrack" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Privacy" /V "DisconnectedState" /T REG_DWORD /D "2" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Privacy" /V "DownloadContentDisabled" /T REG_DWORD /D "2" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\Privacy" /V "UsercontentDisabled" /T REG_DWORD /D "2" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Excel\Security" /V "BlockContentExecutionFromInternet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Excel\Security" /V "ExcelByPassEncryptedMacroScan" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Excel\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\MS Project\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\MS Project\Security" /V "Level" /T REG_DWORD /D "4" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Outlook\Security" /V "Level" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\PowerPoint\Security" /V "BlockContentExecutionFromInternet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\PowerPoint\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Publisher\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Visio\Security" /V "BlockContentExecutionFromInternet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Visio\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Word\Security" /V "BlockContentExecutionFromInternet" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Word\Security" /V "VBAWarnings" /T REG_DWORD /D "4" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Word\Security" /V "WordByPassEncryptedMacroScan" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\Feedback" /V "Enabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\Feedback" /V "IncludeEmail" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\Feedback" /V "IncludeScreenshot" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\Feedback" /V "MSORIdSurveyEnabled" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common" /V "QMEnable" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\OSM" /V "EnableFileObfuscation" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\OSM" /V "EnableLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\OSM" /V "EnableUpload" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\Common\Blog" /V "DisableBlog" /T REG_DWORD /D "2" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\ClientTelemetry" /V "DisableTelemetry" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\ClientTelemetry" /V "SendTelemetry" /T REG_DWORD /D "3" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\15.0\Common\ClientTelemetry" /V "VerboseLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\ClientTelemetry" /V "DisableTelemetry" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\ClientTelemetry" /V "SendTelemetry" /T REG_DWORD /D "3" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\16.0\Common\ClientTelemetry" /V "VerboseLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\ClientTelemetry" /V "DisableTelemetry" /T REG_DWORD /D "1" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\ClientTelemetry" /V "SendTelemetry" /T REG_DWORD /D "3" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\17.0\Common\ClientTelemetry" /V "VerboseLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\Common\ClientTelemetry" /V "DisableTelemetry" /T REG_DWORD /D "1" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\Common\ClientTelemetry" /V "VerboseLogging" /T REG_DWORD /D "0" /F >NUL 2>&1
...
REG ADD "HKEY_CURRENT_USER\SOFTWARE\Policies\Microsoft\Office\Common\Security" /V "AutomationSecurity" /T REG_DWORD /D "3" /F >NUL 2>&1
...
PowerShell -Command "Get-WindowsCapability -Online -Name "Language.Handwritingen*" | Remove-WindowsCapability -Online" /F >NUL 2>&1
PowerShell -Command "Get-WindowsCapability -Online -Name "Language.OCRen*" | Remove-WindowsCapability -Online" /F >NUL 2>&1
PowerShell -Command "Get-WindowsCapability -Online -Name "Language.Speechen*" | Remove-WindowsCapability -Online" /F >NUL 2>&1
PowerShell -Command "Get-WindowsCapability -Online -Name "Language.TextToSpeechen*" | Remove-WindowsCapability -Online" /F >NUL 2>&1
